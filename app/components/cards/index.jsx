...
export default function Cards() {
  return (
    <main className="grid grid-flow-col gap-x-14  justify-center  bg-gradient-to-r from-[#25244d] via-[#4f4e9c] via-[#6967c2] to-[#25244d]">
      {/* main Card */}
        <div className="flex gap-20">
          ...
          <div className ="flex items-center justify-center ">
            <div className="  absolute -top-5 drop-shadow-xl ">
              <header className=" h-14 w-64 rounded-xl bg-gradient-to-r py-3 from-[#3a4a7f] to-[#c67c64] text-center text-xl font-medium  text-white">
          ...
          <footer className=" mb-10 flex justify-center">
            <button class="flex items-baseline gap-2 rounded-lg bg-[#7fbffa] px-4 py-2.5 text-xl font-normal text-white hover:bg-[#FF7308]">
              <span>Explore</span>
            </button>
          </footer>
        </div>
