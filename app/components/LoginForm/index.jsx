...
<input 
  ...
  >
    Password
          ...
          <button  className="bg-green-400 text-white font-bold cursor-pointer px-6 py-2 hover:bg-green-700">Login</button>
          {error && (
          <div className="bg-red-500 text-white w-fit text-sm py-1 px-3 rounded-md mt-2">
            ...
            Don't have an account? <span className="underline hover:text-green-500">Register</span>
          </Link>
          </form>
      </div>
    </div>
