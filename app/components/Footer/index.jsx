      ...
      <div className="container flex flex-col justify-between py-10  space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/4">
          ...
          <li>
            ...
            <p className="text-xs">
            1st Floor, Peddar House, Proctor Street, Nxt To Kamla Niwas, Grant Road,Mumbai <br/>Maharashtra,400007
            </p>
            <div className="mt-3 text-sm font-medium" >T. +91 5462781456</div>
            </div>
          </li>
          </ul>
        </div>
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-3">
          ...
          <div className="space-y-3">
            <div className="uppercase font-bold dark:text-gray-50">Contact us</div>
          ...
          <div className="space-y-3">
            <div className="tracking-wide  dark:text-gray-50">Subscribe to our newsletter</div>
            <ul className="space-y-1">
              <li>
